...
Once the pre-release `v0.2.5` GitHub release is published, use its public
...
- `app-builder-0.2.5.tar.gz`
- `app-builder-codex-marketplace-0.2.5.tar.gz`
...
commands fail closed until `v0.2.5` exists:
...
- `app-builder-0.2.5.tar.gz`, the portable Agent Plugins package
- `app-builder-codex-marketplace-0.2.5.tar.gz`, a self-contained
...
(
  ...
  mkdir app-builder-marketplace-0.2.5
  tar -xzf app-builder-codex-marketplace-0.2.5.tar.gz \
    -C app-builder-marketplace-0.2.5
  codex plugin marketplace add "$PWD/app-builder-marketplace-0.2.5"
  codex plugin add app-builder@autograph
)
```
