...
Once the pre-release `v0.2.10` GitHub release is published, use its public
...
- `app-builder-0.2.10.tar.gz`
- `app-builder-codex-marketplace-0.2.10.tar.gz`
...
commands fail closed until `v0.2.10` exists:
...
- `app-builder-0.2.10.tar.gz`, the portable Agent Plugins package
- `app-builder-codex-marketplace-0.2.10.tar.gz`, a self-contained
...
(
  ...
  mkdir app-builder-marketplace-0.2.10
  tar -xzf app-builder-codex-marketplace-0.2.10.tar.gz \
    -C app-builder-marketplace-0.2.10
  codex plugin marketplace add "$PWD/app-builder-marketplace-0.2.10"
  codex plugin add app-builder@autograph
)
```
