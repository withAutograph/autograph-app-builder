...
export default defineEval({
  description:
    "Canceling change-set acceptance preserves the exact passed validation receipt and never publishes.",
  async test(t) {
    ...
    t.succeeded();
    t.check(t.reply, includes('"phase":"validated"'));
    ...
    t.succeeded();
    t.check(t.reply, includes("validated receipt was preserved"));
