...
export const hostedStorageExpectedColumns = [
  ...
  ["agent_session", "adapter_generation", "integer", false],
  ["agent_session", "adapter_session_id", "text", true],
  ["agent_session", "audience", "text", true],
  ["agent_session", "checkpoint_digest", "text", false],
  ["agent_session", "checkpoint_progress_digest", "text", false],
  ["agent_session", "created_at", "timestamp with time zone", true],
  ["agent_session", "issuer", "text", true],
  ["agent_session", "last_progress_at", "timestamp with time zone", false],
  ["agent_session", "owner_user_id", "text", true],
  ["agent_session", "parent_session_id", "text", false],
  ["agent_session", "record", "jsonb", true],
  ["agent_session", "resumability_state", "text", false],
  ["agent_session", "session_id", "text", true],
  ["agent_session", "stage", "text", false],
  ...
  ["builder_handoff", "expires_at", "timestamp with time zone", true],
  ["builder_handoff", "handoff_id", "text", true],
  ["builder_handoff", "intent", "jsonb", true],
  ["builder_handoff", "issuer", "text", true],
  ["builder_handoff", "owner_user_id", "text", true],
  ["builder_handoff", "redeemed_at", "timestamp with time zone", false],
  ["builder_handoff", "request_digest", "text", true],
...
export const hostedStorageExpectedConstraints = [
  ...
  ["agent_operation", "agent_operation_tenant_pk"],
  ["agent_session", "agent_session_adapter_generation_check"],
  ["agent_session", "agent_session_checkpoint_digest_check"],
  ["agent_session", "agent_session_checkpoint_progress_digest_check"],
  ...
  ["builder_handoff", "builder_handoff_pkey"],
  ["builder_handoff", "builder_handoff_redemption_check"],
  ["builder_handoff", "builder_handoff_request_digest_check"],
...
const namedObjectRowSchema = z
  .object({ name: z.string(), table: z.string() })
  .strict();
...
export async function verifyHostedStorageReadBack(input: {
  ...
  if (
    ...
    JSON.stringify(
      contract.migrations.map(({ hash, createdAt }) => ({ createdAt, hash }))
    )
  ) {
