...
const developmentWorkspaceInspectionProgram = [
  ...
  'const repositoryInput=path.join(workspaceRoot,"repository");',
  "const repositoryState=fs.statSync(repositoryInput);",
  "if(!repositoryState.isDirectory())process.exit(1);",
