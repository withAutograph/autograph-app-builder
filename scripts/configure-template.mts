...
const originValue = originIndex >= 0 ? process.argv[originIndex + 1] : undefined;
if (!originValue) throw new Error("Usage: pnpm configure --origin https://agent.example.com");
